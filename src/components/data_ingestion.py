...
class DataIngestion:
    ...
    def export_collection_as_dataframe_from_mongodb(self):
        """
        Export entire collection as dataframe
        """
        logging.info("Entered export_collection_as_dataframe_from_mongodb method of DataIngestion class")
        try:
    ...
    def initiate_data_ingestion(self):
        try: 
            dataframe = self.export_collection_as_dataframe_from_mongodb()
